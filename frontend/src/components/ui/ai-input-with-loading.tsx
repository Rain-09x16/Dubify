  ...
  return (
    <div className={cn("w-full py-4", className)}>
      <div className="relative max-w-xl w-full mx-auto flex items-start flex-col gap-2">
        <div className="relative max-w-xl w-full mx-auto">
          <Textarea
            ...
            className={cn(
              ...
              "border-[#1A73E8]/30 ring-[#1A73E8]/50 focus-visible:ring-[#1A73E8]",
              "text-[#1F2937] resize-none text-wrap leading-[1.2]",
              `min-h-[${minHeight}px]`
            )}
            ref={textareaRef}
            value={inputValue}
          ...
          <button
            ...
            className={cn(
              ...
              submitted ? "bg-none" : "bg-[#1A73E8]/10 hover:bg-[#1A73E8]/20"
            )}
            type="button"
            disabled={submitted}
          >
            {submitted ? (
              <div
                className="w-4 h-4 bg-[#1A73E8] rounded-sm animate-spin transition duration-700"
                style={{ animationDuration: "3s" }}
              />
            ) : (
              <CornerRightUp
                className={cn(
                  "w-4 h-4 transition-opacity text-[#1A73E8]",
        ...
        <p className="pl-4 h-4 text-xs mx-auto text-[#6B7280]">
